$(document).ready(function() {
    ...
    const palabrasClavePorPagina = {
        "1Papa.html": ["papá"],
        "2Mama.html": ["mamá"],
        "3Hermana.html": ["hermana"],
        "4Hermano.html": ["hermano"],
        "5Abuela.html": ["abuela"],
        "6Abuelo.html": ["abuelo"],
        "7Tios.html": ["tios"],
        "8Primos.html": ["primos"],
        "9Familia.html": ["familia"],
    };
    ...
    function mostrarModal(imagenSrc) {
        ...
        setTimeout(() => {
            ...
            if (imagenSrc === '../assets/correcto.png') {
                if (paginaActual === "1Papa.html") {
                    window.location.href = "2Mama.html";
                } else if (paginaActual === "2Mama.html") {
                    window.location.href = "3Hermana.html";
                } else if (paginaActual === "3Hermana.html") {
                    window.location.href = "4Hermano.html";
                } else if (paginaActual === "4Hermano.html") {
                    window.location.href = "5Abuela.html";
                } else if (paginaActual === "5Abuela.html") {
                    window.location.href = "6Abuelo.html";
                } else if (paginaActual === "6Abuelo.html") {
                    window.location.href = "7Tios.html";
                } else if (paginaActual === "7Tios.html") {
                    window.location.href = "8Primos.html";
                } else if (paginaActual === "8Primos.html") {
                    window.location.href = "9Familia.html";
                } else if (paginaActual === "9Familia.html") {
                    window.location.href = "ActividadF.html";
                }
            }
...
const audioMap = {
    'inicioFamilia.html': {
        botonAudio1: '../../assets/AUDIOS/LAFAMILIA/inicio Fam.aac',
    },
    '1Papa.html': {
        botonAudio1: '../../assets/AUDIOS/LAESCUELA/ESCUCHA Y REPITE LA PALABRA.aac',
        botonAudio2: '../../assets/AUDIOS/LAFAMILIA/papá .aac'
    },
    '2Mama.html': {
        botonAudio2: '../../assets/AUDIOS/LAFAMILIA/mamá 1.aac'
    },
    '3Hermana.html': {
        botonAudio2: '../../assets/AUDIOS/LAFAMILIA/hermana.aac'
    },
    '4Hermano.html': {
        botonAudio2: '../../assets/AUDIOS/LAFAMILIA/hermano.aac'
    },
    '5Abuela.html': {
        botonAudio2: '../../assets/AUDIOS/LAFAMILIA/abuela.aac'
    },
    '6Abuelo.html': {
        botonAudio2: '../../assets/AUDIOS/LAFAMILIA/abuelo.aac'
    },
    '7Tios.html': {
        botonAudio2: '../../assets/AUDIOS/LAFAMILIA/tios.aac'
    },
    '8Primos.html': {
        botonAudio2: '../../assets/AUDIOS/LAFAMILIA/primos.aac'
    },
    '9Familia.html': {
        botonAudio2: '../../assets/AUDIOS/LAFAMILIA/familia .aac'
    }
